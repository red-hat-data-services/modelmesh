...
public class LegacyModelMeshService {
  ...
  public static class AsyncClient extends com.ibm.watson.modelmesh.thrift.ModelMeshService.AsyncClient implements AsyncIface {
    ...
    public static class deleteModel_call extends org.apache.thrift.async.TAsyncMethodCall<Void> {
      ...
      public Void getResult() throws com.ibm.watson.modelmesh.thrift.InternalException, InvalidStateException, org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        (new Client(prot)).recv_deleteModel();
        return null;
      }
    }
  ...
  public static class Processor<I extends Iface> extends com.ibm.watson.modelmesh.thrift.ModelMeshService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class addModel<I extends Iface> extends org.apache.thrift.ProcessFunction<I, addModel_args, addModel_result> {
      public addModel() {
        super("addModel");
      }
      ...
      @Override
      public addModel_result getEmptyResultInstance() {
        return new addModel_result();
      }

      @Override
      public addModel_result getResult(I iface, addModel_args args) throws org.apache.thrift.TException {
        addModel_result result = getEmptyResultInstance();
        try {
    ...
    public static class ensureLoaded<I extends Iface> extends org.apache.thrift.ProcessFunction<I, ensureLoaded_args, ensureLoaded_result> {
      public ensureLoaded() {
        super("ensureLoaded");
      }
      ...
      @Override
      public ensureLoaded_result getEmptyResultInstance() {
        return new ensureLoaded_result();
      }

      @Override
      public ensureLoaded_result getResult(I iface, ensureLoaded_args args) throws org.apache.thrift.TException {
        ensureLoaded_result result = getEmptyResultInstance();
        try {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.ibm.watson.modelmesh.thrift.ModelMeshService.AsyncProcessor<I> {
    ...
    public static class addModel<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, addModel_args, com.ibm.watson.modelmesh.thrift.StatusInfo, addModel_result> {
      public addModel() {
        super("addModel");
      }
    ...
    public static class ensureLoaded<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, ensureLoaded_args, com.ibm.watson.modelmesh.thrift.StatusInfo, ensureLoaded_result> {
      public ensureLoaded() {
        super("ensureLoaded");
      }
    ...
    public static class deleteModel<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, deleteModel_args, Void, deleteModel_result> {
      public deleteModel() {
        super("deleteModel");
      }
    ...
    public static class getStatus<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, getStatus_args, com.ibm.watson.modelmesh.thrift.StatusInfo, getStatus_result> {
      public getStatus() {
        super("getStatus");
      }
